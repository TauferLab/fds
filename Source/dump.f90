...
! OUR OWN FORMAT
ALLOCATE(FORMAT_ASCII(NMESHES))
ALLOCATE(OUTPUT_ASCII(NMESHES))
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   ! Our own output file
   FORMAT_ASCII(NM) = GET_FILE_NUMBER()
   WRITE(OUTPUT_ASCII(NM), '(A,I4.4,A)') 'OUTPUT_',NM,'.txt'
...
! Output our own format
OPEN(FORMAT_ASCII(NM), FILE=OUTPUT_ASCII(NM), STATUS='REPLACE')
WRITE(FORMAT_ASCII(NM), fmt=*) IJKE
CLOSE(FORMAT_ASCII(NM))
